...
$value = $parsedYAML.parameter.nupkgArtifactsPublishingPath
Write-Host "##vso[task.setvariable variable=param.nupkgArtifactsPublishingPath;isOutput=true]$value"
$value = $parsedYAML.parameter.zipArtifactsPublishingPath
Write-Host "##vso[task.setvariable variable=param.zipArtifactsPublishingPath;isOutput=true]$value"
